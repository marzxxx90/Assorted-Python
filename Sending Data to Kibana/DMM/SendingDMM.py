...
def main():
    ...
    strSql +="Case "
    strSql +="When Substring(SAFACCOUNTNUMBER from 3 for 3) In (00004, 00031, 00015, 00007, 00002) Then 'Business Center I' "
    strSql +="When Substring(SAFACCOUNTNUMBER from 3 for 3) In (00001, 00005, 00003, 00008, 00032, 00006) Then 'Business Center II' "
    strSql +="When Substring(SAFACCOUNTNUMBER from 3 for 3) In (00011, 00010, 00009, 00022, 00026, 00014) Then 'Business Center III' "
    strSql +="When Substring(SAFACCOUNTNUMBER from 3 for 3) In (00017, 00025, 00028, 00029, 00021, 00018, 00024) Then 'Business Center IV' "
